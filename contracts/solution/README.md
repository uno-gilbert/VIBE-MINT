...
Remix는 `@openzeppelin/contracts@5.1.0/...` 경로를 **자동으로 GitHub에서 가져옵니다.**  
...
| `ParserError` / 버전 불일치 | Compiler를 **0.8.31**로 맞춤 |
| `mcopy not found` | Compiler **0.8.31** + EVM **osaka** + import `@5.1.0` |
